...
class Task(Serializable):
    """ Pydantic model containing data for a specific task """
    year: int = 2024
    number: int = 1
    team_size: int = 1
...
class SubmissionList(Serializable):
    """ Pydantic model containing IDs of the submission list message """
...
class Config(Serializable):
    """ Main pydantic model containing all persistent data """
